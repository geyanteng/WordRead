...
namespace WordRead
{
    ...
    public partial class frmWordRead : Form
    {
        ...
        {
            this.tbParentGuid.Text = "090ee5f5-1d77-4561-a17b-8b464aaad7aa";
            this.tbParentDepth.Text = "2";
            this.tbParentIDfolder.Text =
            "#f088ad64-8a9e-4ef6-a3e3-ac872a380283#ea00e0c5-53ca-4ce3-80b6-ff727c27f0b0#090ee5f5-1d77-4561-a17b-8b464aaad7aa";
            this.tbParentTitleCnFolder.Text =
            "0#@`船舶检验技术规则#@`内河船舶";
            this.tbHtmlPath.Text = @"../../../htmlRcgTest/3-nhcb(14_big53)/num20/1.htm";
            this.tbFilesPath.Text = @"/Uploads/imagesrc/neihechuanbo/num20";
            this.tbTitle1SpanStyle.Text = @"font-size:16.0pt;font-family:黑体";
            this.tbTitle2SpanStyle.Text = @"font-family:楷体";
            /*****************************************/
